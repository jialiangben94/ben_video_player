...
@interface BLTVideoPlayerPlugin () <FLTVideoPlayerApi>
...
@implementation BLTVideoPlayerPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  BLTVideoPlayerPlugin* instance = [[BLTVideoPlayerPlugin alloc] initWithRegistrar:registrar];
